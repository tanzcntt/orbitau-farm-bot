...
def check_screen(screen):
    try:
        ...
        pass
    # try:
    #     if pyautogui.locateOnScreen("./resources/screens/battling.png", region=(settings[screen]['region']['left'], settings[screen]['region']['top'], settings[screen]['region']['width'], settings[screen]['region']['height']), confidence=0.9):
    #         return {
    #             "name": "battling",
    #             "data": {}
    #         }
